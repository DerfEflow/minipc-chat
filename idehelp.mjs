...
export const CRUCIBLE_GUIDE = [
  ...
  "  the compass handle in the middle of the message bar: a small copper hub with three arrows",
  "  pointing up, left and right. PRESS it and a black circular dial opens with the name of every",
  "  surface written above the arrow that goes there (up for The Crucible, left for the Forge dial,",
  "  right for the Image forge, and Chat when you are inside a panel); one tap goes there. Pressing",
  "  anywhere else closes the dial. Dragging the handle in a direction works the same way. A copper",
  ...
  "- Vibe coder and Engineer keep the classic page: the same conversation with every option below it",
  "  in labelled drawers for a vibe coder, and drawers first (Workspace, Brief, Assignments,",
  "  Register) with the conversation underneath for an engineer. The mode sets how you talk.",
