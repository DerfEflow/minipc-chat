...
export const CRUCIBLE_GUIDE = [
  ...
  "",
  "- The Crucible (shown to beginners as App Builder) is Dominion's build surface. It opens from",
  ...
  "  Pressing Send (it wears a small chevron for this reason) extends the destinations from it,",
  "  downward on desktop and UPWARD on phones so the on-screen keyboard never hides them:",
  "  Send here, or to the other windows by",
