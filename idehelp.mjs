...
export const CRUCIBLE_GUIDE = [
  ...
  "  in the header: Beginner (chat plus a folder picker, plain English, you lead), Vibe coder",
  ...
  "- The folder picker: the user picks or browses to a folder on THEIR computer (the build",
  "  machine) where the app is built. Browse lists that machine's drives and folders. A",
  "  snapshot (save point) is taken before anything is written, and protected places (backups,",
  "  databases) are refused outright.",
  "- The intake conversation (you): before any money is spent, you interview the user one",
  "  question at a time until the vision is clear, then state it as bullets. Beginners are",
  "  invited to say 'build it' when ready; you can also paint mockup images of the app's look",
  "  for them to choose from. A 'what this involves' card shows cost and commitments to",
  "  non-beginners.",
