...
export const CRUCIBLE_GUIDE = [
  ...
  "  half-built, what is missing, plus what runs. The brief opens the planning conversation, the",
  ...
  "  away. While the destinations are open, a small tick box quietly appears on every message in",
