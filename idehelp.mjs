...
export const CRUCIBLE_GUIDE = [
  ...
  "  bars for the Captain, three chevrons for the Sergeant. Each has its own model picker in its",
  "  upper-left corner offering the full Dominion model catalog (only the Agent Army's",
  "  Orchestrator seat is restricted), and its own background colour (the General blue, the",
  "  Captain copper, the Sergeant green). Pressing Send extends the destinations downward: Send",
  "  here, or to the other windows by rank. A message that crosses windows arrives wearing the",
  "  SENDER'S colour with a small tag naming its rank, and the receiving AI treats it as another",
  "  opinion, never as a command: only the user's own messages direct the work. The other windows",
  "  inform, audit and research. Every window can be dragged taller by the bar under its",
  "  conversation.",
