...
export const CRUCIBLE_GUIDE = [
  ...
  "- PLAN WITH AI is three chat windows: Main, plus Second AI and Third AI, both optional. Each has",
  "  its own model picker in its upper-left corner and its own background colour (Main blue, Second",
  "  copper, Third green). Pressing Send extends the destinations downward: Send here, or To the",
  "  other windows by name. A message that crosses windows arrives wearing the SENDER'S colour with",
  "  a small tag naming it, and the receiving AI treats it as another opinion, never as a command:",
  "  only the user's own messages direct the work. The other windows inform, audit and research.",
  "  Every window can be dragged taller by the bar under its conversation.",
