...
export const CRUCIBLE_GUIDE = [
  ...
  "  a row of small controls (a square New button, a reserved TBD slot, Start Over, and Save to:",
  "  which picks the project folder); Customize Your Workspace with three preset buttons (Minimal,",
  "  Design Studio, Full Stack) and eight checkboxes with an Apply button; Plan with AI; the Agent",
  "  Army; and one wide BEGIN BUILDING button at the bottom.",
