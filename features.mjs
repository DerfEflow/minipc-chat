...
export const FEATURES = [
  {
    ...
    how: [
      ...
      "Finished images land in YOUR IMAGES, the gallery beside the controls on a computer and below them on a phone, where they can be opened, favorited, searched and downloaded.",
    ],
    notes: "Images are stored in the user's own browser on their own device, never in the cloud, and browser storage is not permanent: to keep one they must download it, or choose a download folder on a desktop browser so every new picture is saved there automatically (phone browsers cannot hold a folder; Save to Photos is the phone path). The back arrow or the close button returns to chat.",
  },
  {
    id: "forge-dial",
  ...
  },
  {
    ...
    how: [
      ...
      "Vibe Coder gets its own screen: a draggable project slider, a Customize Your Workspace panel, Plan with AI (a Main window plus optional Second and Third AI windows in their own colours, each with its own model, able to relay opinions to each other), an Agent Army table with an Orchestrator row and live cost and time estimates per task, and one wide BEGIN BUILDING button.",
      "Engineer shows the same build with everything open: model choices, budgets, the file tree, diffs, and the agent crew window.",
    ],
