...
export const FEATURES = [
  {
    ...
    how: [
      ...
      "Finished images land in YOUR FORGED VISIONS, the gallery beside the deck on a computer and below it on a phone, where they can be opened, favorited, searched and downloaded.",
    ],
    notes: "Images are stored in the user's own browser on their own device, never in the cloud, and browser storage is not permanent: to keep one they must download it, or link a folder on a desktop browser so every new picture is written there automatically (phone browsers cannot hold a folder link; Save to Photos is the phone path). The back arrow or the close button returns to chat.",
  },
  {
    id: "forge-dial",
